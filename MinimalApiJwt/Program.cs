...
builder.Services.AddAuthentication()
    .AddJwtBearer("Bearer", jwtOptions =>
    {
        ...
        // Use the same authority as your Entra External ID configuration
        jwtOptions.Authority = "https://myobintegrationcustomers.ciamlogin.com/0dcb505d-c3a8-4a5e-945f-e900363cf2b6/v2.0";

        // The audience should match your client ID
        ...
        jwtOptions.Audience = "bb47349e-e638-4a37-a082-fd2137bee380";

        // For development only: Allow HTTP metadata endpoints
        if (builder.Environment.IsDevelopment())
        {
            jwtOptions.RequireHttpsMetadata = false;
        }

        // Optional: Add token validation parameters for better debugging
